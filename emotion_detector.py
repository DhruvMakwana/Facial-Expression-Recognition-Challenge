...
#--model checkpoints/vgg100/epoch_100.hdf5
...
#load the face detector cascade, emotion detection CNN, then define the list of emotion 
#labels
...
while True:
	...
	#initialize the canvas for the visualization, then clone the frame so we can draw on it
